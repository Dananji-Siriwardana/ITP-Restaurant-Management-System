...
const PlaceOrder = ({ storedData }) => {
  ...
  const AddShipping =(e) => {
    ...
    if (!name || !address || !province || !district || !town || !mail || !phone) {
      // Display error alert if any debit card field is empty
      alert("Please fill out all fields");}
      else if (!regex.test(phone)) {
        alert("Please enter a valid Sri Lankan phone number"); // Display error alert if phone number is not valid
        return;
                      ...
                      <div className="container">
                          ...
                          <Form.Group className="mb-3" controlId="name" >
                            ...
                            <Form.Group className="mb-3" controlId="district">
                              ...
                              <Form.Control as="select" onChange={(e) => setDistrict(e.target.value)}>
                            ...
                            <Form.Group className="mb-3" controlId="town"  >
                              ...
                              <Form.Control type="text" placeholder="Town" onChange={(e) => {
                            ...
                            <Button variant="primary" type="submit" onClick={AddShipping}>
